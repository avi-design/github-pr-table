...
const [modalDetailsData, setmodalDetailsData] = useState<ModalDetails | undefined>();
    ...
    {modalDetailsData !== undefined &&
      <Modal show={showModal} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title><strong>{modalDetailsData.title}</strong></Modal.Title>
        </Modal.Header>
        <Modal.Body>{modalDetailsData.body}</Modal.Body>
        <Modal.Footer>
         <span><strong>last Updated at : {formatLastUpdatedTime(modalDetailsData.updated_at)}</strong></span>   
